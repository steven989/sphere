    ...
    def populate_connection_modal
        ...
        if last_plan || last_checkin
            if last_checkin && !last_plan
                ...
                last_activity_time_string = last_plan.last_activity_date_difference_humanized(timezone)
