class ConnectionsController < ApplicationController
    ...
    def populate_connection_modal
        ...
        actions= [{action:"function_call",function:"populateBubblesModal()"},{action:"function_call",function:"checkInButtons(#{check_in_button_state})"},{action:"function_call",function:"initializeReModal('[data-remodal-id=bubbleModal]','standardModal',3)"}]
        respond_to do |format|
          format.json {
