class Level < ActiveRecord::Base
    ...
    def self.individual_level(current_user)
    ...
    # use a recursive algorithm to find the level. Start with a mid point, if both this element and the element to its right is true, then go to the right half. If this element is false, go to the left half. If this element is true and the next one is false, or this is the last element, then return the level
