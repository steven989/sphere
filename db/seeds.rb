...
Challenge.create!([
  {name: "Grab 5 coffees this week", instructions: "Meet up with people you know or don't know and learn something new about them.", description: nil, criteria: " (@level@ >=4)", repeated_allowed: true, graphic: nil, days_to_complete: 7, reward: nil},
  {name: "Learn something new about your oldest friend", instructions: "Who's your oldest friend? Do you think you know everything about him/her already? Let's find out!", description: "This is the first challenge ever created", criteria: " (@level@ >=6)", repeated_allowed: false, graphic: nil, days_to_complete: 7, reward: nil},
